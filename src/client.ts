...
export interface ClientOptions {
  /**
   * Defaults to process.env['ANYFORMAT_API_KEY'].
   */
   ...
   *
   * Defaults to process.env['ANYFORMAT_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['ANYFORMAT_LOG'] or 'warn' if it isn't set.
   */
...
/**
 * API Client for interfacing with the Anyformat API.
 */
export class Anyformat {
  apiKey: string | null;
   ...
   * API Client for interfacing with the Anyformat API.
   *
   * @param {string | null | undefined} [opts.apiKey=process.env['ANYFORMAT_API_KEY'] ?? null]
   * @param {string} [opts.baseURL=process.env['ANYFORMAT_BASE_URL'] ?? https://api.anyformat.ai] - Override the default base URL for the API.
   ...
   */
  constructor({
    baseURL = readEnv('ANYFORMAT_BASE_URL'),
    apiKey = readEnv('ANYFORMAT_API_KEY') ?? null,
    ...opts
  }: ClientOptions = {}) {
    const options: ClientOptions = {
      apiKey,
      ...opts,
      baseURL: baseURL || `https://api.anyformat.ai`,
    };

    this.baseURL = options.baseURL!;
    this.timeout = options.timeout ?? Anyformat.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('ANYFORMAT_LOG'), "process.env['ANYFORMAT_LOG']", this) ??
      defaultLogLevel;
  ...
  static Anyformat = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static AnyformatError = Errors.AnyformatError;
...
Anyformat.Health = Health;
Anyformat.Webhooks = Webhooks;
Anyformat.Files = Files;
Anyformat.Workflows = Workflows;
