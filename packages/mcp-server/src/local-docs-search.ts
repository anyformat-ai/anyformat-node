...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'name: string;',
      "nodes: { id: string; type: 'parse'; effort?: 'low' | 'mid' | 'accurate'; engine?: 'Fast' | 'Performant'; figure_enhancement?: boolean; mode?: 'standard' | 'agentic'; prompt_hint?: string; visual_grounding_enabled?: boolean; } | { id: string; categories: { id: string; description: string; name: string; }[]; type: 'classify'; user_prompt?: string; } | { id: string; rules: { id: string; description: string; name: string; partition_key?: string; }[]; type: 'splitter'; } | { id: string; extraction_schema: { fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: object[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: object[]; name: string; } | object[]; }[]; }; type: 'extract'; engine?: 'Fast' | 'Performant'; lookup_files?: string[]; lookup_schema?: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | object[]; }[]; lookup_suggestion?: string; mode?: 'standard' | 'agentic'; use_images?: boolean; } | { id: string; rules: { id: string; description: string; name?: string; severity?: 'error' | 'warning'; source_fields?: string[]; }[]; type: 'validate'; }[];",
      'description?: string;',
    ...
    markdown:
      "## create\n\n`client.workflows.create(name: string, nodes: { id: string; type: 'parse'; effort?: 'low' | 'mid' | 'accurate'; engine?: 'Fast' | 'Performant'; figure_enhancement?: boolean; mode?: 'standard' | 'agentic'; prompt_hint?: string; visual_grounding_enabled?: boolean; } | { id: string; categories: { id: string; description: string; name: string; }[]; type: 'classify'; user_prompt?: string; } | { id: string; rules: { id: string; description: string; name: string; partition_key?: string; }[]; type: 'splitter'; } | { id: string; extraction_schema: { fields: object | object | object | object | object | object | object | object | object[]; }; type: 'extract'; engine?: 'Fast' | 'Performant'; lookup_files?: string[]; lookup_schema?: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: object[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: object[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: object | object | object | object | object | object | object | object | object[]; }[]; lookup_suggestion?: string; mode?: 'standard' | 'agentic'; use_images?: boolean; } | { id: string; rules: { id: string; description: string; name?: string; severity?: 'error' | 'warning'; source_fields?: string[]; }[]; type: 'validate'; }[], description?: string, edges?: { source: string; target: string; branch?: string; }[]): { id: string; name: string; created_at?: string; description?: string; fields?: object[]; updated_at?: string; }`\n\n**post** `/v2/workflows/`\n\nCreate a workflow from a strongly-typed graph (atomic).\n\nProvide an explicit list of typed `nodes` (parse / classify / splitter /\nextract) and `edges` between them. The full workflow — fields, nodes,\nrouting — is created in a single transaction.\n\n### Parameters\n\n- `name: string`\n\n- `nodes: { id: string; type: 'parse'; effort?: 'low' | 'mid' | 'accurate'; engine?: 'Fast' | 'Performant'; figure_enhancement?: boolean; mode?: 'standard' | 'agentic'; prompt_hint?: string; visual_grounding_enabled?: boolean; } | { id: string; categories: { id: string; description: string; name: string; }[]; type: 'classify'; user_prompt?: string; } | { id: string; rules: { id: string; description: string; name: string; partition_key?: string; }[]; type: 'splitter'; } | { id: string; extraction_schema: { fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: object[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: object[]; name: string; } | object[]; }[]; }; type: 'extract'; engine?: 'Fast' | 'Performant'; lookup_files?: string[]; lookup_schema?: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | object[]; }[]; lookup_suggestion?: string; mode?: 'standard' | 'agentic'; use_images?: boolean; } | { id: string; rules: { id: string; description: string; name?: string; severity?: 'error' | 'warning'; source_fields?: string[]; }[]; type: 'validate'; }[]`\n\n- `description?: string`\n\n- `edges?: { source: string; target: string; branch?: string; }[]`\n\n### Returns\n\n- `{ id: string; name: string; created_at?: string; description?: string; fields?: object[]; updated_at?: string; }`\n  A workflow defines the extraction template — what fields to extract from documents, their types, and validation rules.\n\n  - `id: string`\n  - `name: string`\n  - `created_at?: string`\n  - `description?: string`\n  - `fields?: object[]`\n  - `updated_at?: string`\n\n### Example\n\n```typescript\nimport Anyformat from 'anyformat-ai';\n\nconst client = new Anyformat();\n\nconst workflow = await client.workflows.create({ name: 'Invoice or receipt', nodes: [{ id: 'x', type: 'parse' }] });\n\nconsole.log(workflow);\n```",
    perLanguage: {
      typescript: {
