...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## create\n\n`client.workflows.create(fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: object[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: object[]; name: string; } | object[]; }[], name: string, description?: string): { id: string; name: string; created_at?: string; description?: string; fields?: object[]; updated_at?: string; }`\n\n**post** `/v2/workflows/`\n\nCreate a new extraction workflow.\n\nWorkflows define what data to extract from documents. After creating a workflow,\nconfigure its extraction fields in the [AnyFormat dashboard](https://app.anyformat.ai).\n\n### Parameters\n\n- `fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'object'; description: string; name: string; nested_fields: { data_type: 'string'; description: string; name: string; } | { data_type: 'integer'; description: string; name: string; } | { data_type: 'float'; description: string; name: string; } | { data_type: 'boolean'; description: string; name: string; } | { data_type: 'date'; description: string; name: string; } | { data_type: 'datetime'; description: string; name: string; } | { data_type: 'enum'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | { data_type: 'multi_select'; description: string; enum_options: { description: string; name: string; }[]; name: string; } | object[]; }[]`\n  Field definitions. Each entry's shape is determined by its `data_type`.\n\n- `name: string`\n  Workflow name\n\n- `description?: string`\n  Workflow description\n\n### Returns\n\n- `{ id: string; name: string; created_at?: string; description?: string; fields?: object[]; updated_at?: string; }`\n  A workflow defines the extraction template — what fields to extract from documents, their types, and validation rules.\n\n  - `id: string`\n  - `name: string`\n  - `created_at?: string`\n  - `description?: string`\n  - `fields?: object[]`\n  - `updated_at?: string`\n\n### Example\n\n```typescript\nimport Anyformat from 'anyformat-ai';\n\nconst client = new Anyformat();\n\nconst workflow = await client.workflows.create({ fields: [{\n  data_type: 'string',\n  description: 'x',\n  name: 'invoice_number',\n}], name: 'Invoice Processing' });\n\nconsole.log(workflow);\n```",
    perLanguage: {
      typescript: {
