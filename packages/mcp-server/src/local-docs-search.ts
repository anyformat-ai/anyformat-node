...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: ['fields: object[];', 'name: string;', 'description?: string;'],
    response:
  ...
  },
  {
    ...
    response:
      '{ collection_id: string; classifications?: { category: string; confidence: number; evidence?: string; }[]; extraction?: object; extractions?: { fields: object; partition?: string; split_name?: string; }[]; parse?: { markdown: string; }; splits?: { confidence: number; files: { file_id: string; file_name: string; pages: number[]; }[]; name: string; partitions?: { confidence: number; files: object[]; name: string; }[]; }[]; verification_url?: string; }',
    markdown:
